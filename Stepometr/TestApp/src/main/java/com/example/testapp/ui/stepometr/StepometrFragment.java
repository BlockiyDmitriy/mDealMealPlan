...
import com.example.testapp.ui.stepometr.pedometr.PedometerService;
import com.example.testapp.ui.stepometr.pedometr.PedometerSharedPreferences;
...
public class StepometrFragment extends Fragment {

    private StepometrViewModel mViewModel;
    ...
    public static StepometrFragment newInstance() {
        return new StepometrFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.stepometr_fragment, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(StepometrViewModel.class);
